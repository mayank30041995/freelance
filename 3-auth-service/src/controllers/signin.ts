...
import { BadRequestError, IAuthDocument, isEmail } from '@mayank30041995/jobber-shared';
...
// import { BadRequestError, IAuthDocument, IEmailMessageDetails, isEmail } from '@mayank30041995/jobber-shared';
// import { Request, Response } from 'express';
// import { StatusCodes } from 'http-status-codes';
// import { omit } from 'lodash';
...
//   let userBrowserName = '';
//   let userDeviceType = '';
//   if (browserName !== (existingUser as any).browserName || deviceType !== (existingUser as any).deviceType) {
//     // min 6 digits and max 6 digits
//     // 100000 - 999999
//     const otpCode = randomInt(10 ** 5, 10 ** 6 - 1);
//     // send email with otp
//     const messageDetails: IEmailMessageDetails | unknown = {
...
//     userBrowserName = `${(existingUser as any).browserName}`;
//     userDeviceType = `${(existingUser as any).deviceType}`;
